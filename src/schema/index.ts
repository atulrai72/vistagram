...
export const commentSchema = z.object({
    comment: z.string().max(500, {message: "Please write your comment upto 500 characters."}),
    postId: z.number(),
})

export const updatePasswordSchema = z.object({
    oldPassword: z.string(),
    newPassword: z.string().min(6, {message: "Password must be minimum 6 characters."}),
